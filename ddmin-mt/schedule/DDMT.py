...
if __name__ == '__main__':
    ...
    parser.add_argument("--tname",help="")
    args=parser.parse_args();
    
    #file="/home/tzl/SIR/MT-and-DD/data/schedule/v"+str(args.vID)+"/ftc/"+args.tname+"_arg"

    file="/home/tzl/0DDMT/SIR/MT-and-DD/data/schedule/args/"+args.tname
    fp=open(file,"r")
    file_args=fp.read()

    trg_exe="../v"+str(args.vID)+"/"+args.trgPrefix+str(args.vID)+".exe"+" "+file_args
    f_ftc=args.ftc
